...
from app.schemas import attendance,ApiResponse
from app.databases import get_sqlite_db
from sqlalchemy.orm import Session
from app.models import Staff,Student,Standard,Attendance
...
async def mark_attendance(request : Request,attendance_request : attendance.CreateAttendanceRequest, attendance_params : Annotated[attendance.CreateAttendanceQueryParams,Query()],db : Session = Depends(get_sqlite_db),current_user :Staff = Depends(get_current_user)):
    try:
